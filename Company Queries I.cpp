// Link to this code: https://cses.fi/paste/391eb64245ce73199734ce/
...
v32 adj[MAXN],d(MAXN,0);
// f(MAXN,0),d(MAXN,0),p(MAXN);
vv32 dp(MAXN,v32(22,0));
